...
exports.LanguagesClass = void 0;
class LanguagesClass {
    constructor() {
        /* PRIVATE */
        //return string "ltr" if the language is written from left to right or "rtl" in other case
        this.getLangDirection = (p_langcode) => {
            return this._langs.rtl[p_langcode] ? "rtl" : "ltr";
        };
        /* PUBLIC */
        //return boolean value, true if langcode is supported
        this.isValid = (p_langcode) => {
            // eslint-disable-next-line no-prototype-builtins
            return this._langs.lang.hasOwnProperty(p_langcode);
        };
        //return object {"name": name of the language in English, "nativeName", "direction"}
        //if langcode isn't supported return {}
        this.getLanguageInfo = (langcode) => {
            const result = {};
            if (this.isValid(langcode)) {
                const lang = this._langs.lang[langcode];
                result["name"] = lang[0];
                result["nativeName"] = lang[1];
                result["direction"] = this.getLangDirection(langcode);
            }
            return result;
        };
        this.getAllLanguageCode = () => {
            try {
                return Object.keys(this._langs.lang);
            }
            catch (error) {
                return [];
            }
        };
        this.getAllLanguageCodeQ = () => {
            try {
                return Object.keys(this._langs.lang).length;
            }
            catch (error) {
                return 0;
            }
...
exports.LanguagesClass = LanguagesClass;
