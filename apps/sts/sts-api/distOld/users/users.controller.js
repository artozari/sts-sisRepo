...
let UsersController = class UsersController {
    ...
    updateByEmail(email, updateUserDto) {
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'email', type: String, example: 'john.deere@example.com' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Process completed.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Not found.' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Update one user by email' }),
    (0, swagger_1.ApiParam)({ name: 'email', type: String, example: 'john.deere@example.com' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Process completed.' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request.' }),
