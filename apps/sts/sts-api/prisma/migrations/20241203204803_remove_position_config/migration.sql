/*
  ...
  - You are about to drop the column `positionX` on the `Config_table` table. All the data in the column will be lost.
  - You are about to drop the column `positionY` on the `Config_table` table. All the data in the column will be lost.
...
INSERT INTO "new_Config_table" ("b12", "b18", "b36", "b6", "b7", "b9", "bCha1", "bCha2", "chip", "colorOfLights", "createdAt", "description", "enabled", "id", "lang", "lang2", "lang3", "lightsIntensity", "max", "min", "semaphoreIntensity", "skin", "skin2", "skin3", "skin4", "skin5", "skin6", "skin7", "skin8", "skinRotationTime", "statisticsQ", "tableId", "tableNumber", "updatedAt", "userId", "wheelType") SELECT "b12", "b18", "b36", "b6", "b7", "b9", "bCha1", "bCha2", "chip", "colorOfLights", "createdAt", "description", "enabled", "id", "lang", "lang2", "lang3", "lightsIntensity", "max", "min", "semaphoreIntensity", "skin", "skin2", "skin3", "skin4", "skin5", "skin6", "skin7", "skin8", "skinRotationTime", "statisticsQ", "tableId", "tableNumber", "updatedAt", "userId", "wheelType" FROM "Config_table";
