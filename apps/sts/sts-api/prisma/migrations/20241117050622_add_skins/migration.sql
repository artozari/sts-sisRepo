...
INSERT INTO "new_Config_table" ("b12", "b18", "b36", "b6", "b7", "b9", "bCha1", "bCha2", "chip", "colorOfLights", "createdAt", "description", "enabled", "id", "lightsIntensity", "max", "min", "semaphoreIntensity", "skin", "statisticsQ", "tableId", "tableNumber", "updatedAt", "userId", "wheelType") SELECT "b12", "b18", "b36", "b6", "b7", "b9", "bCha1", "bCha2", "chip", "colorOfLights", "createdAt", "description", "enabled", "id", "lightsIntensity", "max", "min", "semaphoreIntensity", "skin", "statisticsQ", "tableId", "tableNumber", "updatedAt", "userId", "wheelType" FROM "Config_table";
