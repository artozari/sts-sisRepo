...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Creates a new configuration.' }),
...
__decorate([
    ...
    __param(1, (0, common_1.Query)('config')),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get a single configuration.' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Process completed.' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Not found.' }),
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_configuration_dto_1.UpdateConfigurationDto]),
    __metadata("design:returntype", void 0)
