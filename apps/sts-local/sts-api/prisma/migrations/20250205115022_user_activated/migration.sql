/*
  ...
  - You are about to alter the column `activated` on the `User_table` table. The data in that column could be lost. The data in that column will be cast from `Boolean` to `DateTime`.
