...
INSERT INTO "new_Config_table" ("b12", "b18", "b36", "b6", "b7", "b9", "bCha1", "bCha2", "chip", "createdAt", "description", "enabled", "id", "max", "min", "tableId", "updatedAt", "userId") SELECT "b12", "b18", "b36", "b6", "b7", "b9", "bCha1", "bCha2", "chip", "createdAt", "description", "enabled", "id", "max", "min", "tableId", "updatedAt", "userId" FROM "Config_table";
