...
const table_class_1 = __importDefault(require("./table/table.class"));
...
const virtual_catch_system_signals_class_1 = require("./virtualCatchSystemSignals/virtual.catch.system.signals.class");
const APP_VERSION = "1.0.0";
const APP_NAME = "sts-table";
// **********************
// *** INITIALIZATION ***
// **********************
...
// *** SYSTEMS SIGNALS ***
// ***********************
const SYSTEMS_SIGNALS = new virtual_catch_system_signals_class_1.VirtualCatchSystemSignalsClass();
// *********************
// *** CONFIGURATION ***
// *********************
...
const MQTT = new mqtt_client_class_1.MqttClientClass(mqttClientConfig, LOGGER);
MQTT.start();
// ***********************
// ****** STS TABLE ******
// ***********************
const tableClassConfigInterface = {
...
const TABLE = new table_class_1.default(tableClassConfigInterface);
// *******************
// *** SERVER HTTP ***
// *******************
const configExpress = {
